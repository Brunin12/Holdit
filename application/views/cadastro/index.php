        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">Pre-encha este pequeno formulario e desfrute do nosso site por tempo ilimitado!.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card z-index-0 border-2 shadow-md">
              ...
              <div class="card-body">
                <form role="form text-left" action="<?= base_url('contas/criar') ?>" method="post">
                  ...
                  <div class="mb-3">
                    <input type="password" class="form-control" placeholder="Senha" aria-label="Senha" aria-describedby="password-addon" name="senha">
                  </div>
                  <div class="form-check form-check-info text-left">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked>
                    <label class="form-check-label" for="flexCheckDefault">
                      Eu aceito <a href="javascript:;" class="text-dark font-weight-bolder">Os Termos de Uso</a>
                    </label>
                  </div>
